...
### 2. 기존 번역한 `기여자 문서` 추가 작업 (기여자님 1명 - "성함A")

`github.com/processing` >...> [contributor_docs > ko](https://github.com/processing/p5.js/tree/main/contributor_docs/ko) 폴더 > [access.md](https://github.com/processing/p5.js/blob/main/contributor_docs/access.md) 파일 복제, 번역 (* 기존 1차 과제와 동일한 깃허브 경로인 점 유의하세요!)
...
### 3. 예제 Examples (기여자님 3명 - "성함B", "성함C", "성함D")
...
"성함B" - 01 ~ 05 총 6개 폴더 내 파일 수정, 번역
"성함C" - 06 ~ 10 총 6개 폴더 내 파일 수정, 번역
"성함D" - 11 ~ 15 총 6개 폴더 내 파일 수정, 번역
